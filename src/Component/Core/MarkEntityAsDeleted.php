...
{
    public function __construct(EntityManagerInterface $entityManager, private readonly CurrentUser $currentUser)
    {
        parent::__construct($this->currentUser, $entityManager);
    }
